...
class Reg {
  public:
    ...
    enum filterMode_t {
        fast = 0x4000,   //!< fast = 42.7us update rate
        medium = 0x8000, //!< medium = 85.3us update rate
        slow = 0xC000    //!< slow = 170.6us update rate
    };
    ...
    enum sensorType_t {
        TLE5012B_E1000, //!< TLE5012B_E1000 Sensor2Go variant
        TLE5012B_E3005 = 0x0,       //!< TLE5012B_E3005
